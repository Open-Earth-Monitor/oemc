...
const SIZE = {
  sm: {
    icon: 'h-4 w-4',
    button: 'h-[14px] w-[14px]',
  },
  md: {
    icon: 'h-5 w-5',
    button: 'h-[25px] w-[25px]',
  },
};
        ...
        >
          ...
          >
            <svg
              ...
              fill="none"
              className={cn({
                'fill-current text-secondary-800 hover:text-secondary-500 active:bg-brand-200':
                  true,
                [SIZE[size].button]: true,
                'h-6 w-5': true,
              })}
                ...
                <g id="Group 1923">
                  <motion.path
                    ...
                    variants={{
                      ...
                      hover: {
                        fill: theme === 'light' ? 'hsl(60, 100%, 95%)' : 'hsl(184, 5%, 19%)',
                      },
                    }}
                  />
                  <motion.path
