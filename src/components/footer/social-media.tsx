...
const THEME = {
  ...
  dark: 'text-brand-500 hover:text-secondary-500',
};

export const SocialMedia: FC<{ theme: 'light' | 'dark' }> = ({ theme = 'light' }) => {
  return (
    <div className="flex items-center space-x-5">
      ...
      >
        <div className={cn({ [CONTROL_BUTTON_STYLES]: true, [THEME[theme]]: !!theme })}>
            ...
            <g id="Group 1925">
              <g id="Group 1923">
                <motion.path
                  ...
                  variants={{
                    initial: {
                      fill: theme === 'light' ? 'hsl(180, 3%, 35%)' : 'hsl(60, 100%, 95%)',
                    },
