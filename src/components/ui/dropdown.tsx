...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn({
        'pointer-events-auto z-50 w-full overflow-hidden border border-secondary-900 bg-brand-500 p-1 text-popover-foreground text-secondary-700 shadow-md data-[state=open]:pointer-events-auto':
          true,
        [className]: !!className,
      })}
      {...props}
