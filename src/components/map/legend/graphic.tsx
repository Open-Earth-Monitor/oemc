    ...
    <div>
      ...
      {type !== 'intervals' && type !== 'ramp' && gs_style && gs_style?.length > 8 && (
        <div className="flex flex-col space-y-1 px-2 py-6">
          <div className="pointer-events-none absolute left-0 right-0 top-0 h-10 bg-gradient-to-t from-transparent via-black-500 to-black-500" />
          ...
          <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-10 bg-gradient-to-t from-black-500 via-transparent to-transparent" />
        </div>
      )}
      {type !== 'intervals' && type !== 'ramp' && gs_style && gs_style?.length <= 8 && (
        <div className="flex">
