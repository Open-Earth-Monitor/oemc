...
const MobileExploreNavbar = () => {
  ...
  return (
    <div className="pointer-events-none fixed bottom-0 left-0 z-50 w-full text-sm">
      <div
        className={cn(
          'z-50 max-h-[calc(100dvh-72px)] overflow-auto bg-black-500 text-white-500 transition-transform',
      ...
      <Button
        className={cn(
          'z-60 pointer-events-auto relative flex h-[60px] w-full justify-between rounded-none border-none bg-black-500 px-6 py-2 text-sm text-white-500',
