...
export default function Custom404() {
  return (
    <div className="h-screen bg-gradient-to-b from-[#0a141e] to-[#0a1520] pt-32">
      <div className="h-full w-full bg-[url('/images/landing/prefooter.webp')] bg-cover bg-top pt-10 text-center text-secondary-500">
